...
mixin InternshipCandidate 
{
  ...
  {
    print("Internship at $company for $duration with stipend of \$${stipend}");
  }
}

class BCAInternshipCandidate extends BCAStudent with InternshipCandidate 
{
  BCAInternshipCandidate(String name, int rollNo, String company, String duration, double stipend) : super(name, rollNo) 
  {
...
class CommerceInternshipCandidate extends CommerceStudent with InternshipCandidate 
{
  CommerceInternshipCandidate(String name, int rollNo, String company, String duration, double stipend) : super(name, rollNo) 
  {
    this.company = company;
    this.duration = duration;
    this.stipend = stipend;
...
void main() 
{
  BCAInternshipCandidate bcaIntern = BCAInternshipCandidate("Aditi", 101, "Microsoft", "6 months", 5000);
  ...
  print("---------------------");
  CommerceInternshipCandidate commerceIntern = CommerceInternshipCandidate("Paurnima", 102, "Finance Inc", "9 months", 2500);
